...
contract ERC165 {
    ...
    bytes4 private constant _INTERFACE_ID_ERC165 = 0x01ffc9a7; //0x01ffc9a7 === bytes4(keccak256('supportsInterface(bytes4)'))
...
contract ERC721 is Pausable, ERC165 {
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(getOwner() != address(0), "Invalid address");
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != ownerOf(tokenId), "Invalid address");
        require(msg.sender == getOwner() || isApprovedForAll(getOwner(), msg.sender));
...
contract TestERC721WIP is ERC721 {
